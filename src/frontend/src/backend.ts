...
import type { Cell as _Cell, Error as _Error, ListChannelsResult as _ListChannelsResult, PostMessageResult as _PostMessageResult, Result as _Result, Result__1 as _Result__1, SlackChannel as _SlackChannel, SlackError as _SlackError, SlackPostResult as _SlackPostResult, UserRole as _UserRole, Value as _Value } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async clearSlackToken(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearSlackToken();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async hasSlackToken(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasSlackToken();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listSlackChannels(): Promise<ListChannelsResult> {
        if (this.processError) {
            try {
                const result = await this.actor.listSlackChannels();
                return from_candid_ListChannelsResult_n17(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async postSlackMessage(arg0: string, arg1: string): Promise<PostMessageResult> {
        if (this.processError) {
            try {
                const result = await this.actor.postSlackMessage(arg0, arg1);
                return from_candid_PostMessageResult_n23(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async saveSlackToken(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveSlackToken(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_ListChannelsResult_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ListChannelsResult): ListChannelsResult {
    return from_candid_variant_n18(_uploadFile, _downloadFile, value);
}
function from_candid_PostMessageResult_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PostMessageResult): PostMessageResult {
...
function from_candid_SlackChannel_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _SlackChannel): SlackChannel {
    return from_candid_record_n21(_uploadFile, _downloadFile, value);
}
function from_candid_SlackPostResult_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _SlackPostResult): SlackPostResult {
...
function from_candid_record_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        name: value.name,
        numMembers: record_opt_to_undefined(from_candid_opt_n22(_uploadFile, _downloadFile, value.numMembers)),
...
function from_candid_record_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ok: value.ok,
        ts: value.ts,
        error: record_opt_to_undefined(from_candid_opt_n27(_uploadFile, _downloadFile, value.error)),
...
function from_candid_variant_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "ok" in value ? {
        __kind__: "ok",
        ok: from_candid_SlackPostResult_n25(_uploadFile, _downloadFile, value.ok)
    } : "err" in value ? {
        __kind__: "err",
        err: value.err
    } : value;
...
function from_candid_vec_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_SlackChannel>): Array<SlackChannel> {
    return value.map((x)=>from_candid_SlackChannel_n20(_uploadFile, _downloadFile, x));
}
